...
const steps = [
  {
    title: 'נאמנות מדורגת',
    desc: 'עוברים מ"כוס עשירית חינם" למערכת חכמה יותר — עם הטבות, דרגות וגישה מוקדמת.',
  },
  {
    title: 'תגמולים דינמיים',
    desc: 'מבצעים חכמים בימים חלשים כדי להגדיל תנועה ולהביא לקוחות.',
  },
  {
    title: 'מתנות יום הולדת',
    desc: 'הטבות אישיות שנשלחות אוטומטית ויוצרות חיבור אמיתי עם הלקוחות.',
  },
]
      ...
      <div className="playbook-grid" style={{
        ...
        <div>
          ...
          <h2 style={{
            ...
            למה מיליוני לקוחות<br />חוזרים שוב ושוב
          </h2>
