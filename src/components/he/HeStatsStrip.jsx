const stats = [
  {
    number: '54M',
    label: 'חברים פעילים',
    description: 'Starbucks Rewards היא תוכנית הנאמנות המסחרית המצליחה ביותר בהיסטוריה.',
  },
  {
    number: '40%',
    label: 'ייחוס הכנסות',
    description: 'כמעט מחצית מכל העסקאות מונעות ישירות על ידי תמריצי נאמנות.',
  },
  {
    number: '$3.6B',
    label: 'כרטיסים טעונים מראש',
    description: 'לקוחות מתייחסים לאפליקציה כמו לחשבון בנק, מה שמבטיח ביקורים חוזרים.',
  },
]
