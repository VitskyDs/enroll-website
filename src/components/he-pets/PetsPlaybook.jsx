const TIERS = [
  ...
  },
  {
    ...
    name: 'לקוח VIP',
    label: 'נאמן',
    qualify: '300 נקודות תוך 12 חודשים',
    earnRate: 'נקודה וחצי לכל ₪1',
    petBirthday: 'שבוע שלם לממש הטבה',
    perk: 'גישה מוקדמת למבצעים',
    accentColor: '#b5830a',
    borderColor: '#d4a017',
  },
  {
    ...
    name: 'לקוח עלית',
    label: 'הדרגה הגבוהה',
    qualify: '1,000 נקודות תוך 12 חודשים או מנוי פעיל',
    earnRate: 'שתי נקודות לכל 1 שקל',
    petBirthday: 'חודש שלם לממש הטבה',
    perk: 'טיפוח מותאם אישית פעם בחודש',
    accentColor: '#9f1b32',
    borderColor: '#9f1b32',
    highlight: true,
  },
...
const HOOKS = [
  ...
  {
    icon: '🎂',
    title: 'אפקט יום ההולדת',
    body: 'הטבה ביום ההולדת של הלקוח מרגישה אישית ומיוחדת, במיוחד כשהיא מגיעה מהמקום שמכיר גם את החיה שלו בשם. זה יוצר קשר רגשי אמיתי עם המותג שלכם.',
  },
  {
    icon: '📊',
    title: 'פס ההתקדמות',
    body: 'כל רכישה מזיזה את המחוג. 7 מתוך 10 ניקובים לטיפוח חינם — הפער הקטן הזה הוא מניע קנייה חזק. הצורך "לסיים את הכרטיסייה" הוא מהכוחות החזקים ביותר בפסיכולוגיה של הצרכן.',
  },
  {
    icon: '👑',
    title: 'סטטוס וזהות',
  ...
  return (
    <section style={{ background: '#fff', padding: '88px 24px 0' }}>
      ...
      <div className="pets-playbook-header">
        ...
        <h2 className="pets-playbook-h2">איך רשתות ענק מחזיקות לקוחות לאורך זמן</h2>
