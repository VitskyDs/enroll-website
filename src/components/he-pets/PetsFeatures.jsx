const FEATURES = [
  {
    icon: '🐾',
    title: 'כרטיסיות ניקובים דיגיטליות',
    body: 'החליפו את כרטיסיית הניקוב הישנה בגרסה דיגיטלית שהלקוחות באמת שומרים. עשרה ניקובים, טיפוח חינם. מעקב אוטומטי, אפס חיכוך.',
    tag: 'הכי פופולרי',
  },
  {
    icon: '🎂',
    title: 'הטבת יום הולדת ללקוח',
    body: 'שולחים אוטומטית הטבה ביום ההולדת של הלקוח. אחת ההטבות עם שיעור ההמרה הגבוה ביותר — והיא רצה לבד.',
    tag: null,
  },
  {
    icon: '🔁',
