        ...
        <section style={{ padding: '0 24px 96px' }}>
          <div style={{
            ...
            <Section id="privacy-policy" title="מדיניות פרטיות">
              <Block>
                אנרול לויאלטי בע"מ ("אנרול", "אנחנו", "שלנו") מפעילה את פלטפורמת מועדון הלקוחות של אנרול. מדיניות פרטיות זו מסבירה אילו מידע אנו אוספים, כיצד אנו משתמשים בו, ואילו אפשרויות עומדות בפניך.
              </Block>
